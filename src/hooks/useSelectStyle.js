...
export const useSelectStyle = () => {
  ...
  const customStyle = {
    control: (provided) => ({
      ...provided,
      backgroundColor: isDarkMode ? "#374151" : "#f9fafb", // bg-gray-700 : bg-gray-50
      borderColor: isDarkMode ? "#4b5563" : "#d1d5db", // border-gray-600 : border-gray-300
    ...
    menu: (provided) => ({
      ...provided,
      backgroundColor: isDarkMode ? "#111827" : "#ffffff", // bg-gray-900 : bg-white
    ...
    option: (provided, state) => ({
      ...
      color: state.isFocused
        ...
        : "#1f2937", // text-gray-100 : text-gray-900
      "&:active": {
        backgroundColor: isDarkMode ? "#4b5563" : "#d1d5db", // bg-gray-600 : bg-gray-300
      },
    }),
    input: (provided) => ({
      ...provided,
