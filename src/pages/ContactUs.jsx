      ...
      <div className="flex-1 flex justify-center ml:w-[50%]  ">
        <div className="py-4  max-w-[30rem]   ">
          ...
          <div className="flex flex-col gap-6">
            <p className="py-3 px-4 border-1 border-color dark:border-gray-500 rounded-md">
              <span></span>
              <span>+0123456789</span>
            </p>
            <p className="py-3 px-4 border-1 border-color bg-[#1F2937] dark:bg-[#33445c] rounded-md text-gray-200 ">
              <span></span>
        ...
        <div className="py-4 max-w-[30rem]  rounded-md  ">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col mt-4 ">
              ...
              <input
                className="bg-white dark:bg-[#1f2937] dark:text-gray-100 shadow lg:w-[22rem]   xl:w-[25rem] w-[22rem] sm:w-[25rem] px-2 pt-3 pb-16 border-t-1 border-color rounded-md my-1 border dark:border-[#b0b0b010] dark:placeholder-gray-400"
                placeholder="Type your message here..."
              />
            </div>
          </div>
          <div className="mt-4 flex justify-center">
            <button className="bg-[#1F2937] dark:bg-[#33445c] text-gray-300 dark:text-white shadow lg:w-[22rem] md:w-[18rem] ml:w-[21rem] xl:w-[25rem] w-[22rem] sm:w-[25rem] px-2 py-3 border-t-1 border-color rounded-sm my-1 text-md flex gap-3 justify-center items-center dark:border-[#b0b0b010]">
              <p>Send Message </p>
              <FaPaperPlane />
            </button>
          </div>
