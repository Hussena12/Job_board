...
const AboutUs = () => {
  ...
  return (
    <div className="mt-28 ">
      <div className="flex flex-col items-center mx-9   mb-40 ">
        <p className="text-2xl mb-2">Our mission:</p>
        <p className="lg:text-6xl md:text-5xl text-3xl mt-6 font-inter text-[#032b2f]">
          WE ACTIVELY
        </p>
        <p className="lg:text-6xl md:text-5xl text-3xl mt-6 font-inter text-[#032b2f] ">
      ...
      <div className="w-full bg-[#002325] pb-24 ">
        <div className=" flex justify-center  pt-32 md:pt-36 ">
          <p className="w-[36rem] text-lg text-white text-center px-6">
        ...
        <div className="flex flex-wrap gap-10 justify-center mt-12  ">
          <div className="w-80 bg-gray-200 rounded-2xl p-11 flex flex-col items-center  ">
            <p className="text-5xl pb-4">#1</p>
            <p className="text-2xl">rated hiring site in Ethiopia</p>
          </div>
          <div className="w-80 bg-gray-200 rounded-2xl p-10 flex flex-col items-center">
      ...
      <div className="flex justify-center">
        <div className="flex rounded-2xl w-[88rem] my-24 mx-6 bg-[#ecebe6] py-24 px-16">
          <div className="flex flex-wrap gap-16">
            <div className="flex flex-col md:w-[48%] justify-center ">
              <p className="text-3xl pb-10 font-semibold">
