  ...
  return (
    <div className="flex gap-4 justify-center">
      <div className="flex flex-col ">
        ...
        <input
          placeholder="Hussen"
          className="bg-white shadow md:w-[8.5rem] w-[10.5rem] sm:w-[12rem] ml:w-[10rem] lg:w-[10.5rem] xl:w-[12rem] px-2 py-3 border-t-1 border-color rounded-sm my-1  dark:bg-[#1F2937] "
        />
      </div>
      <div className="flex flex-col ">
